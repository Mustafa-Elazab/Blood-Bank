...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onViewClicked() {
        ...
        SharedPreferencesManger.SaveData(MapsActivity.this,"LATITUDE",String.valueOf(latitude));
        SharedPreferencesManger.SaveData(MapsActivity.this,"LONGITUDE",String.valueOf(longitude));
        FrameLayout frameLayout = findViewById(R.id.Frame_replace_maps);
